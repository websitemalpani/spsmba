'use client';
import Link from 'next/link';import {ArrowUpRight,X} from 'lucide-react';import {useEffect,useState} from 'react';import type {HomepagePopup} from '@/lib/api';
...
export function HomepagePopupModal({popup,image}:{popup:HomepagePopup;image:string|null}){
  ...
  return <div className="fixed inset-0 z-[100] grid place-items-center bg-navy/70 backdrop-blur-sm p-5" role="dialog" aria-modal="true" aria-label={popup.title||'Announcement'} onClick={close}>
    <div className="relative flex max-h-[88vh] w-full max-w-md flex-col overflow-hidden rounded-3xl bg-white shadow-2xl" onClick={(e)=>e.stopPropagation()}>
      ...
      <div className="overflow-y-auto overscroll-contain">
        ...
        {image&&<img src={image} alt="" className="block w-full h-auto bg-mist"/>}
        <div className="p-7">
